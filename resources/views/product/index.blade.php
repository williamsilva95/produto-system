                        ...
                        <div class="col mb-5">
                            <div class="card h-100">
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="{{url('editar-produto/'.$value->id)}}" class="btn btn-primary btn-sm mr-3" role="button">Editar</a>
                                    <a href="{{url('deletar-produto/'.$value->id)}}" onClick="deletar()" class="btn btn-danger btn-sm " role="button">Deletar</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
